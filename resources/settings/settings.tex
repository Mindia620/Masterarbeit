...
\colorlet{Interviewer}{BurntOrange}
\colorlet{Interviewee}{ForestGreen}
...
\usepackage{booktabs,tabularx,longtable,threeparttable}
\usepackage[table]{xcolor} % für rowcolors
\usepackage{makecell,multirow} % \thead, Zeilen-/Spaltenzusammenfassung
\usepackage{siunitx} % saubere Zahlen
\usepackage{caption}
